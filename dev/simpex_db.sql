...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2024 at 07:01 AM
...
CREATE TABLE `users` (
  ...
  `role` enum('customer','admin','chiefCoordinator','operationsCoordinator','HrCoordinator','employee') NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
