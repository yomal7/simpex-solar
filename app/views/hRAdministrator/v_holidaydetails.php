        ...
        <div class="main-content">
            <div class="container">
                <div class="record-details-container">
                    <div class="actions">
                        <button class="back-button" onclick="window.location.href='<?php echo URLROOT; ?>/hRAdministrator/holiday'" class="back-btn">
                            Back to records
                        </button>
                    </div>
                    <div class="details">
                            ...
                            <div class="record-info">
                                <div class="indetail">
                                    ...
                                    <div class="info-group">
                                        ...
                                        <span>EMP<?php echo str_pad($data['record']->employee_id, 6, '0', STR_PAD_LEFT); ?></span>
                                    </div>
