    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="employee-form-container">
                <h2 class="form-title">Create Employee Profile</h2>
                <form action="<?php echo URLROOT; ?>/hRAdministrator/addEmployee" method="POST" id="employeeForm" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo URLROOT; ?>/hRAdministrator/employees" class="btn-link"><button type="button" class="btn btn-secondary">Cancel</button></a>
                    </div>
                </form>
            </div>
        </div>
