                                        ...
                                        if (isset($project->current_phase)) {
                                            ...
                                            if (!in_array($project->current_phase, $projectPhases)) {
                                                switch($project->current_phase) {
                                                    case 'quotation': $progress = 10; break;
                                                    case 'site_visit': $progress = 25; break;
                                                    case 'agreement': $progress = 40; break;
                                            ...
                                            // Main project phases (40-100%)
                                                ...
                                                switch($project->current_phase) {
                                                    case 'document_submission': $progress = 45; break;
                                                    case 'first_payment': $progress = 55; break;
                                                    case 'installation': $progress = 70; break;
                                                    case 'final_payment': $progress = 80; break;
                                                    case 'engineer_approval': $progress = 90; break;
                                                    case 'grid_connection': $progress = 95; break;
                                                    case 'completed': $progress = 100; break;
                                                    default: $progress = 50; break;
                                                }
                                            }
        ...
        <div class="orders-section">
            ...
            <?php else: ?>
                <div style="text-align: center; padding: 30px 0;">
                    ...
                    <a href="<?php echo URLROOT; ?>/shop" class="btn" style="display: inline-block; margin-top: 15px;">Browse Shop</a>
                </div>
            <?php endif; ?>
        </div>
    </main>
