                    ...
                    <?php if (empty($data['activeProjects'])): ?>
                        <div class="no-projects">
                            <div class="no-projects-icon">
                                <i class="material-icons-sharp">technicianing</i>
                            </div>
                            ...
                            <?php foreach ($data['activeProjects'] as $project): ?>
                                <div class="project-card">
                                    ...
                                    <div class="project-actions">
                                        <a href="<?php echo URLROOT; ?>/technician/viewInstallation/<?php echo $project->installation_id; ?>" class="btn btn-primary">
                                            View Details
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="projects-grid">
                            <?php foreach ($data['completedProjects'] as $project): ?>
                                <div class="project-card">
                                    ...
                                    <div class="project-actions">
                                        <a href="<?php echo URLROOT; ?>/technician/viewInstallation/<?php echo $project->installation_id; ?>" class="btn btn-secondary">
                                            View Details
                                        </a>
                                    </div>
                                </div>
