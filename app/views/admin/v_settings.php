            ...
            <div class="settings-container">
                ...
                <div class="settings-sections">
                    ...
                    <div class="settings-card">
                        ...
                        <form action="<?php echo URLROOT; ?>/admin/settings" method="POST" enctype="multipart/form-data" class="settings-form">
                    ...
                    <div class="settings-card">
                        ...
                        <form action="<?php echo URLROOT; ?>/admin/settings" method="POST" class="settings-form">
