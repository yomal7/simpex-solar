...
<body>
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a href="<?php echo URLROOT ?>/operationsCoordinator/settings" class="active">
            ...
            <div class="settings-container">
                ...
                <div class="settings-sections">
                    ...
                    <div class="settings-card">
                        ...
                        <form action="<?php echo URLROOT; ?>/operationsCoordinator/settings" method="POST" enctype="multipart/form-data" class="settings-form">
                    ...
                    <div class="settings-card">
                        ...
                        <form action="<?php echo URLROOT; ?>/operationsCoordinator/settings" method="POST" class="settings-form">
