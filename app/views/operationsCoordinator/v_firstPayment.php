...
<body>
        ...
        <div class="main-content">
            <div class="container">
                ...
                <div class="page-header">
                    <h1>First Payment Management</h1>
                ...
                <div class="card finance-card">
                    ...
                    <div class="card-body">
                        <?php if ($data['agreement']): ?>
                            ...
                            <div class="finance-row first-payment">
                                <span class="finance-label">First Payment Amount (25%):</span>
                        ...
                        <?php elseif (!$data['payment']->payment_status): ?>
                            ...
                            <div class="payment-details">
                                ...
                                <?php if ($data['payment']->payment_method == 'cash'): ?>
                                    <!-- Cash payment form -->
                                    <form action="<?php echo URLROOT; ?>/operationsCoordinator/processPayment" method="post" id="cashPaymentForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="amount" name="amount"
                                                value="<?php echo $data['first_payment_amount']; ?>"
                                                min="<?php echo $data['first_payment_amount']; ?>"
                                                max="<?php echo $data['agreement']->total_price; ?>"
                                                step="0.01" required>
                                            <div class="amount-constraints">
                                                <small>Minimum: Rs. <?php echo number_format($data['first_payment_amount'], 2); ?> (25% of total)</small>
                                                <small>Maximum: Rs. <?php echo number_format($data['agreement']->total_price, 2); ?> (Full payment)</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bank-slip-details">
                                            ...
                                            <?php if ($data['bank_slip']->status == 'pending'): ?>
                                                <div class="bank-slip-preview">
                                                    ...
                                                    <form action="<?php echo URLROOT; ?>/operationsCoordinator/acceptBankSlip" method="post" id="acceptSlipForm">
                                                        <input type="hidden" name="project_id" value="<?php echo $data['project']->project_id; ?>">
                                                        <input type="hidden" name="payment_id" value="<?php echo $data['payment']->id; ?>">
    ...
    <div id="rejectModal" class="modal">
        <div class="modal-content">
            ...
            <form action="<?php echo URLROOT; ?>/operationsCoordinator/rejectBankSlip" method="post" id="rejectSlipForm">
                <input type="hidden" name="project_id" value="<?php echo $data['project']->project_id; ?>">
    ...
    <div id="confirmModal" class="modal">
        <div class="modal-content">
            ...
            <div class="confirm-details">
                <p>You are about to process a payment with the following details:</p>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value" id="confirmAmount">Rs. 0.00</span>
                </div>
            </div>
            <div class="modal-buttons">
    ...
    <script>
        ...
        function confirmCashPayment() {
            ...
            if (isNaN(amount) || amount < <?php echo $data['first_payment_amount']; ?> ||
                amount > <?php echo $data['agreement']->total_price; ?>) {
                alert('Please enter a valid amount (between 25% and 100% of total)');
                return;
            }

            document.getElementById('confirmAmount').textContent = 'Rs. ' + amount.toLocaleString('en-US', {
