                ...
                <div class="info-section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <p class="info-value"><?php echo $data['customer']->customer_name; ?></p>
                        </div>
                        <div class="info-item">
                            <p class="info-label">Phone</p>
                            <p class="info-value"><?php echo $data['customer']->phone; ?></p>
                        </div>
                        <div class="info-item">
                            <p class="info-label">Email</p>
                            <p class="info-value"><?php echo $data['customer']->email; ?></p>
                        </div>
                        <div class="info-item">
                            <p class="info-label">Address</p>
                            <p class="info-value"><?php echo $data['customer']->address ?? $data['customer']->location; ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="details-section">
                    ...
                    <div class="details-grid">
                        <div class="detail-card">
                            ...
                            <p><strong>Package Name:</strong> <?php echo $data['preproject']->package_name ?? 'Not specified'; ?></p>
                        ...
                        <!-- Financial Details card has been removed -->
                    </div>
                </div>
            </div>
