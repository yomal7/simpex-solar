...
<body data-user-role="operationsCoordinator" data-user-id="<?php echo $_SESSION['user_id']; ?>" data-urlroot="<?php echo URLROOT; ?>">
        ...
        <div class="main-content">
            <div class="container">
                <div class="agreement-form">
                    ...
                    <div class="revision-request-section">
                        <h3>Customer Revision Request</h3>
                        <div class="revision-message">
                            <?php echo nl2br(htmlspecialchars($data['agreement']->revision_request)); ?>
                        </div>
                    </div>

                    <form id="agreementForm" action="<?php echo URLROOT; ?>/operationsCoordinator/updateAgreement/<?php echo $data['agreement']->agreement_id; ?>" method="POST">
                        <!-- Hidden inputs -->
                        <input type="hidden" name="old_agreement_id" value="<?php echo $data['agreement']->agreement_id; ?>">
                        ...
                        <div class="form-sections">
                            ...
                            <section class="info-section">
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span><?php echo isset($data['project']->nearest_city) ? $data['project']->nearest_city : ''; ?></span>
                                    </div>
                                    <div class="info-item">
                                        <label>Contact:</label>
                            ...
                            <section class="info-section">
                                ...
                                <div class="detail-item">
                                    ...
                                    <input type="number" id="system_capacity" name="system_capacity" 
                                        value="<?php echo isset($data['agreement']->system_capacity) ? $data['agreement']->system_capacity : '0'; ?>" 
                                        step="0.01" required>
                                </div>
                                <div class="detail-item">
                                    ...
                                    <input type="number" id="estimated_generation" name="estimated_generation" 
                                        value="<?php echo isset($data['agreement']->estimated_generation) ? $data['agreement']->estimated_generation : '0'; ?>" 
                                        required>
                                </div>
                            </section>
                            ...
                            <section class="info-section">
                                ...
                                <div class="price-item">
                                    ...
                                    <span id="basePrice">Rs. <?php echo number_format($data['agreement']->base_price ?? 0, 2); ?></span>
                                    <input type="hidden" name="base_price" value="<?php echo $data['agreement']->base_price ?? 0; ?>">
                                </div>
                                <div class="price-item">
                                    <label for="service_charge">Service Charge:</label>
                                    <input type="number" id="service_charge" name="service_charge" 
                                        value="<?php echo $data['agreement']->service_charge ?? 0; ?>" 
                                        onchange="updateTotalPrice()">
                                </div>
                                <div class="price-item total">
                                    <label>Total Price:</label>
                                    <span id="totalPrice">Rs. <?php echo number_format($data['agreement']->total_price ?? 0, 2); ?></span>
                                    <input type="hidden" name="total_price" value="<?php echo $data['agreement']->total_price ?? 0; ?>">
                                </div>
                            </section>
                            ...
                            <section class="info-section">
                                ...
                                <textarea id="notes" name="notes" rows="4" 
                                    placeholder="Add any important notes about the agreement..."><?php echo $data['agreement']->notes ?? ''; ?></textarea>
                            </section>
                        </div>
    ...
    <script src="<?php echo URLROOT; ?>/js/operationsCoordinator/agreementRevision.js"></script>
